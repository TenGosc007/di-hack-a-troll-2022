  ...
  return (
    <main className={styles.home}>
      <header className={styles.container1}>
        ...
        <section className={styles.container1__txt}>
      ...
      <article className={styles.container2} id="one">
        <section className={styles.container1__txt}>
      ...
      <article className={styles.container3} id="two">
        <section className={styles.container3__all}>
          <div className={styles.container1__grap}>
        ...
        <footer className={styles.container3__footer}>
